          ...
          <div className="px-4 lg:px-6 py-3 flex flex-col md:flex-row gap-3 md:items-center md:justify-between">
            ...
            >
              <TabsList className="flex flex-wrap justify-start">
                ...
                <TabsTrigger value="task" className="data-[state=active]:bg-blue-50">
                  Tasks <Badge variant="secondary" className="ml-2">{counts.task}</Badge>
                </TabsTrigger>
                <TabsTrigger value="mention" className="data-[state=active]:bg-blue-50">
                  Mentions <Badge variant="secondary" className="ml-2">{counts.mention}</Badge>
                </TabsTrigger>
                <TabsTrigger value="project" className="data-[state=active]:bg-blue-50">
                  Projects <Badge variant="secondary" className="ml-2">{counts.project}</Badge>
                </TabsTrigger>
                <TabsTrigger value="system" className="data-[state=active]:bg-blue-50">
                  System <Badge variant="secondary" className="ml-2">{counts.system}</Badge>
                </TabsTrigger>
              </TabsList>
            </Tabs>
